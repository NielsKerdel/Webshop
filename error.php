...
$codes = array(
    300 => array('300 Bad Query', 'The request cannot be fulfilled due to bad Query.'),
    301 => array('301 Bad ID', 'The request cannot be fulfilled due to Bad ID.'),
    302 => array('302 Double Primary', 'The request cannot be fulfilled due to multiple primary key.'),
